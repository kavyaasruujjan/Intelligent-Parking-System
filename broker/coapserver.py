...
from exampleresources import BasicResource, Long, Separate, Storage, Big, voidResource, XMLResource, ETAGResource, Child, MultipleEncodingResource, AdvancedResource, AdvancedResourceSeparate #, DynamicResource
...
class CoAPServer(CoAP):
    def __init__(self, host, port, multicast=False):
        ...
        self.add_resource('getid/', BasicResource())
        ...
        self.add_resource('parkingspot/', AdvancedResource())
